...
{ 
    ...
    [System.Management.Automation.PSCredential ]$AdUserCreds = New-Object System.Management.Automation.PSCredential ("${DomainName}\$($Usercreds.UserName)", $Usercreds.Password)
    ...
    Node localhost
    {
        ...
        xADUser $AdUserCreds.UserName
        {
            Ensure     = 'Present'
            UserName   = $Usercreds.UserName
            Password   = $AdUserCreds.Password
            DomainName = $DomainName
